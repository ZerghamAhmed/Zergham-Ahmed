...
def match():
    ...
    courses = ["request.form.get('course1')", "request.form.get('course2')", "request.form.get('course3')", "request.form.get('course4')",
    "request.form.get('course5')", "request.form.get('course6')", "request.form.get('course7')", "request.form.get('course8')",
    "request.form.get('course9')", "request.form.get('course10')", "request.form.get('course11')", "request.form.get('course12')"]
