...
# Template so that Sign up doesn't keep showing
@app.route("/prematch")
def prematch():
...
def match():
    ...
    #make dictionary of comparisons and open csv
        ...
        course9 = request.form.get("course1")
        course10 = request.form.get("course1")
        course11 = request.form.get("course1")
        course12 = request.form.get("course1")
